   ...
   <div class="pot-nav">
      <div class="container">
          <ul class="nav navbar-nav hidden-xs">
            ...
            <?php if($loggedin){ ?>
            <li class="pot-nav">
              <a href="/trading/profile" class="menu"> <i class="fa fa-exchange" aria-hidden="true"></i>
                 profile</a>
            </li>
            <li class="pot-nav">
                <a href="/trading/settings"class="menu"> <i class="fa fa-cogs" aria-hidden="true"></i>
   ...
   color: #ecdb6c;
            ...
            <div class="container">
              <div class="content-dark">
                ...
                <div class="line"></div>
                <div class="text">
                   You're changing your public settings. All the content shown below is visible to everyone whos visiting your profile.
                   <br>
                   <p>
                     <!--
                     <tr>
                       ...
                       <td style="padding: 5px;">
                         <input type="text" readonly name="name" placeholder="Max 32 alphanumeric characters (A-Z, a-z, 0-9)" required="required" class="input-txt" style="color: #888a8b;" />
                         <div id="fix-name"></div>
                         <span style="color:red;">You're not allowed to change username. If you want to chane it, request a ticket here</span>
                       </td>
                     </tr>
                   -->
                     <br><p>
                     <tr>
                       ...
                       <td style="padding: 5px;">
                         <select name="platform" required="required" class="input-txt" style="color: #888a8b;">
                           <option disabled selected hidden>Trading platform</option>
                           <option>PC</option>
                           <option>PS4</option>
                           <option>Xbpx</option>
                         </select>
                     ...
                     <br><p>
                       <tr>
                         <td style="width: 25%; padding: 5px; text-align: right;">
                           <div class="register-field1">Platform username (SteamID, XBOX Gamer Tag, PS4 Online ID)</div>
                           <div style="color:red;" id="username-error"></div>
                         </td>
                         <td style="padding: 5px;">
                           <input type="text" name="name" placeholder="Platform username" required="required" class="input-txt" style="color: #888a8b;" />
                           <div id="fix-name"></div>
                         </td>
                       </tr>
                       <p>
                         <br>
                           <div class="btn-new btn" href="#"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</div>
                </div>
              </div>
            </div>
