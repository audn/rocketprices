...
<html>
<head>
  <title>Tickets | Rocket Prices</title>
  <script>
      ...
      <div class="container">
        ...
        <div class="content-dark">
          ...
          <div class="span_4 column">
            <div class="btn-blue">Mark as done</div>
            <p>
            <div class="btn-red">Deactivate user</div>
            <p>
            <div class="btn-red">Warn & Delete</div>
          </div>
        </div>
          ...
          <div class="span_1 column">
            <span id="tradeID">41512ssc2tradeID</span>
            <br>User has <span id="amountWarnings">1</span> warnings.
            <br>This report was made <span id="time">1</span> hour ago.
            <br>Reported by user <span id="username">Anthony</span>.
          </div>
          <div class="span_2 column">
            <span id="title">Type</span>
            <br>
