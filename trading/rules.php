  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
              ...
              (adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <div class="content-dark">
                  ...
                  <div class="line"></div>
                  <div class="text">
                1.  The administration takes no responsibility and can't be held liable for any issues that may arise as a result of a user, participating in trades or interacting with other users on the website. Only the user is responsible for ensuring that the contents of a trade are as expected before finalizing it. All features of this website are offered as-is with no guarantee of any kind.<p>
                2. The administration reserves the right to terminate any account or remove any trade at their discretion.<p>
                3. Any attempt to scam will result in a ban.
                    <li>When reporting scammers, please provide clear evidence (for example screen captures). We can’t take further action without proof. Both PlayStation 4 and XBox One are able to capture video footage, please use these features. Many tools are available for PC, such as <a href="https://www.nvidia.com/en-us/geforce/geforce-experience/shadowplay/#replay/">NVidia Shadowplay</a> or <a href="http://www.amd.com/de/technologies/radeon-relive">AMD ReLive.</a></li><p>
                  4.  Trading with items or currencies that are not part of Rocket League is prohibited by Psyonix' TOS.
                    <li>Their TOS can be found here and their EULA here.</li>
                    <p><br>
                  5.  Giveaways that require any other compensating measure than contact data are not tolerated and will be removed.
                    Following actions result in a warning:
                    <p>
                    <li> Begging</li>
                    <li>Spamming</li>
                    <li>Boosting services</li>
                    <li>Offensive behaviour</li>
                    <li>Promotion of any kind</li>
                  <li>  Multiple account usage</li>
                    Following actions result in a ban:
                    <p>
                  <li>  Duplication services</li>
                    <li>Using bots/scripts to automate actions</li>
                    <li>Trade systems that are solely based on trust</li>
                    The administration reserves the right to alter these rules at any time.
                     <br>
                     <p>
                     <div class="line"></div>
                     <br>
                     We've gotten permission from <a href="http://rocket-league.com/" target="_blank">Rocket-League.com</a> to copy their trading rules.
                   </div>
                 </div>
