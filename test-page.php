        ...
        <p>
          ...
          <div class="trade-template-light">
            <div class="trade-title_left-light">
              <a href="#profile" class="verified">
                <span style="color: #1798e5;"><i class="fal fa-rocket"></i></span> audn</a> wants to trade:
                <br><span style="color: #1798e5;"><i class="fal fa-rocket"></i></span> Verified Rocketprices staff
            </div>
            <div class="trade-title_right-light">
              ...
              <div class="trade-custom-comment-light">
                ...
                <p>
                  ...
                  <div class="btn-delete"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete this trade</div>
                  <?php } ?>
